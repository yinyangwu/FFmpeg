...
Java_com_youngwu_ffmpeg_FFmpegUtil_urlProtocolInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
    av_register_all();
...
JNIEXPORT jstring JNICALL
Java_com_youngwu_ffmpeg_FFmpegUtil_avFormatInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_youngwu_ffmpeg_FFmpegUtil_avCodecInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
JNIEXPORT jstring JNICALL
Java_com_youngwu_ffmpeg_FFmpegUtil_avFilterInfo(JNIEnv *env, jclass type) {
    char info[40000] = {0};
...
Java_com_youngwu_ffmpeg_FFmpegUtil_playVideo(JNIEnv *env, jclass type, jstring videoPath_,
                                                 jobject surface) {
